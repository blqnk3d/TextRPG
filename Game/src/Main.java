...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String choose;
        while (true) {
            System.out.println("List of commands: fight [f]   printhp [php]   quit [q]   shop [s]   inventory [inv]   useitem [ui]");
    ...
    public void fight() {
        ...
        if (player.getLvl() >= player.getMaxExp()) {
            player.levelUp();
        }//! NEEDS FIXING //ToDo Need To do Revive after Death if in inv is revive
        /*
