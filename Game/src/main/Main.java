...
public class Main {
    ...
    public Main() {
        //! inputString("Input the player.Player name : ")
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("List of commands: fight [f] (craft [c] WIP)  printhp [php]   quit [q]   shop [s]   inventory [inv]   useitem [ui] stats");
    ...
    public void fight() {
        //ToDo player.Item Dropps of Mobs
        //ToDo Doesnt check if the player is dead again
        int currentTurn = 0; // 0 = player.Player | 1 = enemy.Enemy
        printEnemys(enemys);
        int enemyFightIndex = inputInt("Which enemy.Enemy do u wanna fight : ");
        try {
